...
KEYCLOAK_PUBLIC_HOST = os.getenv("KEYCLOAK_PUBLIC_HOST")  # for browser redirection
KEYCLOAK_INTERNAL_HOST = os.getenv("KEYCLOAK_INTERNAL_HOST")  # for container-to-container calls
